...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['teacher', 'status'], name='sessions_ap_teacher_73c4a5_idx'),
        ),
        migrations.AddIndex(
            model_name='privatesession',
            index=models.Index(fields=['requested_by', 'status'], name='sessions_ap_request_6d0b17_idx'),
        ),
        migrations.AddIndex(
            model_name='privatesession',
            index=models.Index(fields=['status'], name='sessions_ap_status_a89ba6_idx'),
        ),
        migrations.AddIndex(
            model_name='privatesession',
            index=models.Index(fields=['scheduled_date'], name='sessions_ap_schedul_d86d00_idx'),
        ),
        migrations.AddIndex(
            model_name='chatmessage',
            index=models.Index(fields=['session', 'created_at'], name='sessions_ap_session_f6dc4b_idx'),
        ),
